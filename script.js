...
// bookingSelection.addEventListener('touchmove', logCoordinates);
// bookingSelection.addEventListener('mousemove', logCoordinates);
...
bookingSelection.addEventListener('touchstart', function (event) {
    isDragging = true;
...
function dragMove(event) {
    ...
    bookingSelection.scrollLeft = startScrollLeft - (event.touches[0].clientX - startX);
    console.log('bookingSelection.scrollLeft' + bookingSelection.scrollLeft + " =" + 'startScrollLeft ' + startScrollLeft + 'event.touches[0].clientX : ' + event.touches[0].clientX + 'startX' + startX);
...
bookingSelection.addEventListener('touchmove', function (event) {
    clearMargin()
...
// TEMPLATE STRING
//SEAT
// var seatRowOneHTML = document.querySelector("#seat-row-one");
// var seatRowTwoHTML = document.querySelector("#seat-row-two");
...
// var seatRowsHTML = [seatRowOneHTML, seatRowTwoHTML, seatRowThreeHTML, seatRowFourHTML, seatRowFiveHTML, seatRowSixHTML]
// var seatRows = [seat_row_one, seat_row_two, seat_row_three, seat_row_four, seat_row_five, seat_row_six]

// for (var j = 0; j < seatRows.length; j++) {
//     var currentRow = seatRows[j];
//     var currentRowHTML = seatRowsHTML[j];
//     console.log(currentRow);
//     if (j <= 1) {
//         var firstHalfHTML = currentRowHTML.querySelector(".seat-row:first-child");
//         var secondHalfHTML = currentRowHTML.querySelector(".seat-row:last-child");

//         var midpoint = Math.ceil(seatRows[j].length / 2);
//         for (var k = 0; k < midpoint; k++) {
//             var seat = generateSeat(currentRow[k]);
//             console.log("hello" + k);
//             firstHalfHTML.appendChild(seat);
//         }
//         for (var k = midpoint; k < currentRow.length; k++) {
//             var seat = generateSeat(currentRow[k]);
//             console.log("hello 2 = " + k);
//             secondHalfHTML.appendChild(seat);
//         }
//     } else {
//         for (var i = 0; i < seatRows[j].length; i++) {
//             var seat = generateSeat(currentRow[i]);
//             seatRowsHTML[j].appendChild(seat);
//         }
//     }
// }
// function generateSeat(currentSeat) {
